...
const handleFlexDirection = propertyHandler('flex-direction', (props) => {
  return props.isColumn ? 'column !important' : 'row !important'
})
...
const handleJustifyContent = propertyHandler('justify-content', flexHandler('justify'))
const handleAlignItems = propertyHandler('align-items', flexHandler('align'))
